...
@Component({
 tag: 'sd-select',
 styleUrls: ['sd-select.scss', '../../styles/global.css', '../../assets/styles/global.scss'],
 shadow: true,
 assetsDirs: ['../../assets'],
})
export class SdSelect {
 ...
 render() {
  ...
  const searchIconSrc = getAssetPath(`../../assets/${this.searchIcon}`);
     ...
     <div class="sd-select__container">
      ...
      {this.isOpen && (
       <div class="sd-select__dropdown" style={this.dropdownStyle}>
        {this.searchable && (
         <div
          class="sd-select__search-container"
          onClick={event => {
           event.stopPropagation();
          }}
         >
          <img src={searchIconSrc} class="sd-select__search-icon" alt="search icon" />
          <input
           value={this.searchText || ''}
           type="text"
           class="sd-select__search-input"
           placeholder="Search..."
           onInput={event => {
